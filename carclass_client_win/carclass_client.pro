...
LIB_PATH = C:/opencv/opencv-4.5.1/build/install/x64/vc16/lib/

win32:CONFIG(release, debug|release): LIBS += -L$${LIB_PATH} -lopencv_core451
else:win32:CONFIG(debug, debug|release): LIBS += -L$${LIB_PATH} -lopencv_core451d
else:unix: LIBS += -L$${LIB_PATH} -lopencv_core451

INCLUDEPATH += $$PWD/../../opencv/opencv-4.5.1/build/install/x64/vc16
DEPENDPATH += $$PWD/../../opencv/opencv-4.5.1/build/install/x64/vc16

win32:CONFIG(release, debug|release): LIBS += -L$${LIB_PATH} -lopencv_dnn451
else:win32:CONFIG(debug, debug|release): LIBS += -L$${LIB_PATH} -lopencv_dnn451d
else:unix: LIBS += -L$$PWD/../../opencv/opencv-4.5.1/build/install/x64/vc16/lib/ -lopencv_dnn451

INCLUDEPATH += $$PWD/../../opencv/opencv-4.5.1/build/install/x64/vc16
DEPENDPATH += $$PWD/../../opencv/opencv-4.5.1/build/install/x64/vc16

win32:CONFIG(release, debug|release): LIBS += -L$${LIB_PATH} -lopencv_highgui451
else:win32:CONFIG(debug, debug|release): LIBS += -L$${LIB_PATH} -lopencv_highgui451d
else:unix: LIBS += -L$${LIB_PATH} -lopencv_highgui451

INCLUDEPATH += $$PWD/../../opencv/opencv-4.5.1/build/install/x64/vc16
DEPENDPATH += $$PWD/../../opencv/opencv-4.5.1/build/install/x64/vc16

win32:CONFIG(release, debug|release): LIBS += -L$${LIB_PATH} -lopencv_imgproc451
else:win32:CONFIG(debug, debug|release): LIBS += -L$${LIB_PATH} -lopencv_imgproc451d
else:unix: LIBS += -L$${LIB_PATH} -lopencv_imgproc451

INCLUDEPATH += $$PWD/../../opencv/opencv-4.5.1/build/install/x64/vc16
DEPENDPATH += $$PWD/../../opencv/opencv-4.5.1/build/install/x64/vc16

win32:CONFIG(release, debug|release): LIBS += -L$${LIB_PATH} -lopencv_imgcodecs451
else:win32:CONFIG(debug, debug|release): LIBS += -L$${LIB_PATH} -lopencv_imgcodecs451d
else:unix: LIBS += -L$${LIB_PATH} -lopencv_imgcodecs451

INCLUDEPATH += $$PWD/../../opencv/opencv-4.5.1/build/install/x64/vc16
DEPENDPATH += $$PWD/../../opencv/opencv-4.5.1/build/install/x64/vc16

win32:CONFIG(release, debug|release): LIBS += -L$${LIB_PATH} -lopencv_videoio451
else:win32:CONFIG(debug, debug|release): LIBS += -L$${LIB_PATH} -lopencv_videoio451d
else:unix: LIBS += -L$${LIB_PATH} -lopencv_videoio451
